...
export default function SubHeaderOne(){
    ...
    return(
        <div className="flex items-center justify-center min-h-screen bg-radial-gradient-md bg-center bg-contain animate-pulse bg-no-repeat" >
            <h2 className={`${poppins.className} subHeaderTextTwo tracking-tighter text-center text-4xl lg:text-3xl font-semibold bg-gradient-to-r from-gray-50 to-gray-400 bg-clip-text text-transparent break-words`} ref={subHeaderTextTwo}>Follow these steps to successfully<br></br>activate your card.</h2>
        </div>
    )
}
