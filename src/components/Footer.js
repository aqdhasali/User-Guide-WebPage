        ...
        <div className="m-20 flex flex-col">
            <div className="flex-grow">
                <div className="flex flex-col justify-center items-center gap-2">
                    ...
                    <div className="mt-3 p-1 tracking-tighter bg-white border border-slate-300 rounded-xl w-24 text-center bg-zinc-900 text-xs lg:hover:bg-zinc-900"><a href="https://app.primeq.co/#/register">Back to Register</a></div>
